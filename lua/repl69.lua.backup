...
local function set_highlights()
	...
	local default_highlights = {
		...
		MatchParen = { fg = palette.gray500, bg = palette.gray800, blend = 25 },
		...
		BlinkCmpLabel = { fg = palette.gray500 },
		BlinkCmpLabelDeprecated = { fg = palette.gray500, strikethrough = true },
		BlinkCmpLabelMatch = { fg = palette.gray100, bold = styles.bold },
		...
		BlinkCmpKindMethod = { link = "PreProc" },
		BlinkCmpKindSnippet = { link = "String" },
		BlinkCmpKindVariable = { link = "Identifier" },
		BlinkCmpDefault = { fg = palette.gray500 },
		BlinkCmpKindText = { fg = palette.gray500 },
		BlinkCmpKindConstructor = { fg = palette.gray500 },
		BlinkCmpKindField = { fg = palette.gray500 },
		BlinkCmpKindModule = { fg = palette.gray500 },
		BlinkCmpKindProperty = { fg = palette.gray500 },
		BlinkCmpKindUnit = { fg = palette.gray500 },
		BlinkCmpKindValue = { fg = palette.gray500 },
		BlinkCmpKindKeyword = { fg = palette.gray500 },
		BlinkCmpKindColor = { fg = palette.gray500 },
		BlinkCmpKindFile = { fg = palette.gray500 },
		BlinkCmpKindReference = { fg = palette.gray500 },
		BlinkCmpKindFolder = { fg = palette.gray500 },
		BlinkCmpKindEnum = { fg = palette.gray500 },
		BlinkCmpKindEnumMember = { fg = palette.gray500 },
		BlinkCmpKindConstant = { fg = palette.gray500 },
		BlinkCmpKindStruct = { fg = palette.gray500 },
		BlinkCmpKindEvent = { fg = palette.gray500 },
		BlinkCmpKindOperator = { fg = palette.gray500 },
		BlinkCmpKindTypeParameter = { fg = palette.gray500 },
		BlinkCmpKindCodeium = { fg = palette.gray500 },
		BlinkCmpKindCopilot = { fg = palette.gray500 },
		BlinkCmpKindSupermaven = { fg = palette.gray500 },
		BlinkCmpKindTabNine = { fg = palette.gray500 },
