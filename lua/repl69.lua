...
local function set_highlights()
	...
	local default_highlights = {
		...
		Conceal = { bg = "NONE" },
		CurSearch = { fg = palette.black, bg = palette.green },
		...
		Visual = { bg = palette.gray15, blend = 15 },
		-- VisualNOS = {},
		...
		Comment = { fg = palette.gray05, italic = styles.italic },
		...
		Keyword = { fg = palette.white, bold = styles.bold },
		Label = { fg = palette.white },
		LspCodeLens = { fg = palette.gray09 },
		LspCodeLensSeparator = { fg = palette.gray06 },
		LspInlayHint = { fg = palette.gray06, bg = palette.gray06, blend = 10 },
		...
		Todo = { fg = palette.purple, bg = palette.purple, blend = 20, bold = styles.bold },
		Type = { fg = palette.white, bold = styles.bold },
		TypeDef = { link = "Type" },
		...
		["@module"] = { fg = palette.gray21 },
		["@module.builtin"] = { fg = palette.gray21, bold = styles.bold },
		["@label"] = { link = "Label" },
		...
		["@type"] = { fg = palette.gray17 },
		["@type.builtin"] = { fg = palette.gray17, bold = styles.bold },
		-- ["@type.definition"] = {},
		...
		-- ["@keyword.coroutine"] = {},
		-- ["@keyword.function"] = {},
		["@keyword.operator"] = { fg = palette.gray11 },
		["@keyword.import"] = { fg = palette.gray11 },
		["@keyword.storage"] = { fg = palette.gray17 },
		["@keyword.repeat"] = { fg = palette.gray11 },
		["@keyword.return"] = { fg = palette.gray11 },
		["@keyword.debug"] = { fg = palette.gray19 },
		["@keyword.exception"] = { fg = palette.gray11 },

		["@keyword.conditional"] = { fg = palette.gray11 },
		["@keyword.conditional.ternary"] = { fg = palette.gray11 },

		["@keyword.directive"] = { fg = palette.gray15 },
		["@keyword.directive.define"] = { fg = palette.gray15 },
		...
		WhichKeyIcon = { fg = palette.gray11 },
		WhichKeyIconAzure = { fg = palette.gray11 },
		WhichKeyIconBlue = { fg = palette.gray11 },
		WhichKeyIconCyan = { fg = palette.gray17 },
		WhichKeyIconGreen = { fg = palette.leaf },
		WhichKeyIconGrey = { fg = palette.gray11 },
		WhichKeyIconOrange = { fg = palette.gray19 },
		WhichKeyIconPurple = { fg = palette.gray15 },
		WhichKeyIconRed = { fg = palette.gray09 },
		WhichKeyIconYellow = { fg = palette.gray13 },
		...
		MiniIconsBlue = { fg = palette.gray11 },
		MiniIconsCyan = { fg = palette.gray17 },
		MiniIconsGreen = { fg = palette.leaf },
		MiniIconsGrey = { fg = palette.gray11 },
		MiniIconsOrange = { fg = palette.gray19 },
		MiniIconsPurple = { fg = palette.gray15 },
		MiniIconsRed = { fg = palette.gray09 },
		MiniIconsYellow = { fg = palette.gray13 },
		...
		RainbowDelimiterBlue = { fg = palette.gray11 },
		RainbowDelimiterCyan = { fg = palette.gray17 },
		RainbowDelimiterGreen = { fg = palette.leaf },
		RainbowDelimiterOrange = { fg = palette.gray19 },
		RainbowDelimiterRed = { fg = palette.gray09 },
		RainbowDelimiterViolet = { fg = palette.gray15 },
		RainbowDelimiterYellow = { fg = palette.gray13 },
