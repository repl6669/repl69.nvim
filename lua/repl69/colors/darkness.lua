...
local ret = {
  ...
  git = {
    add = hsl(158, 90, 20), -- #00623c (green700)
    change = hsl(240, 90, 25), -- #050561 (blue700)
    delete = hsl(0, 100, 25), -- #8b0000 (red700)
    dirty = hsl(0, 0, 60), -- #999999 (gray300)
    merge = hsl(0, 0, 68), -- #adadad (gray200)
    rename = hsl(0, 0, 44), -- #707070 (gray500)
    stage = hsl(0, 0, 60), -- #999999 (gray300)
    text = hsl(0, 0, 76), -- #c2c2c2 (gray100)
    untracked = hsl(25, 100, 25), -- #892f00 (orange700)
  },
}
