...
function M.get(c, opts)
  ...
  local ret = {
    ...
    -- Profiler
    SnacksProfilerIconInfo    = { bg = Util.blend_bg(c.blue100, 0.3), fg = c.blue100 },
    SnacksProfilerBadgeInfo   = { bg = Util.blend_bg(c.blue100, 0.1), fg = c.blue100 },
    SnacksScratchKey          = "SnacksProfilerIconInfo",
    SnacksScratchDesc         = "SnacksProfilerBadgeInfo",
    SnacksProfilerIconTrace   = { bg = Util.blend_bg(c.blue700, 0.3), fg = c.gray850 },
    SnacksProfilerBadgeTrace  = { bg = Util.blend_bg(c.blue700, 0.1), fg = c.gray850 },
    -- Indent
    SnacksIndent              = { fg = c.gray850, nocombine = true },
    SnacksIndentScope         = { fg = c.gray400, nocombine = true },

    SnacksZenIcon             = { fg = c.purple },
    SnacksInputIcon           = { fg = c.blue100 },
    ...
    SnacksPickerSelected    = { fg = c.pink300},
    SnacksPickerToggle         = "SnacksProfilerBadgeInfo",
    SnacksPickerPickWinCurrent   = { fg = c.fg, bg = c.pink300, bold = true },
