...
function M.get(c, opts)
  ...
  return {
    ...
    BufferInactive        = { bg = Util.blend_bg(c.bg_dark, 0.40), fg = Util.blend_bg(c.gray750, 0.80) },
    BufferInactiveERROR   = { bg = Util.blend_bg(c.bg_dark, 0.40), fg = Util.blend_bg(c.error, 0.80) },
    BufferInactiveHINT    = { bg = Util.blend_bg(c.bg_dark, 0.40), fg = Util.blend_bg(c.hint, 0.80) },
    BufferInactiveINFO    = { bg = Util.blend_bg(c.bg_dark, 0.40), fg = Util.blend_bg(c.info, 0.80) },
    BufferInactiveIndex   = { bg = Util.blend_bg(c.bg_dark, 0.40), fg = c.gray750 },
    BufferInactiveMod     = { bg = Util.blend_bg(c.bg_dark, 0.40), fg = Util.blend_bg(c.warning, 0.80) },
    BufferInactiveSign    = { bg = Util.blend_bg(c.bg_dark, 0.40), fg = c.bg },
    BufferInactiveTarget  = { bg = Util.blend_bg(c.bg_dark, 0.40), fg = c.red },
    BufferInactiveWARN    = { bg = Util.blend_bg(c.bg_dark, 0.40), fg = Util.blend_bg(c.warning, 0.80) },
    BufferOffset          = { bg = c.bg_statusline, fg = c.gray750 },
    BufferTabpageFill     = { bg = Util.blend_bg(c.bg_dark, 0.800), fg = c.gray750 },
